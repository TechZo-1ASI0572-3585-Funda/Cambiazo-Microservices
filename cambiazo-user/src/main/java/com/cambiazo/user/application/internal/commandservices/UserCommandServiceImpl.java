...
//import com.cambiazo.user.exchanges.domain.model.entities.FavoriteProduct;
import com.cambiazo.user.domain.model.entities.Subscription;
import com.cambiazo.user.application.internal.outboundservices.hashing.HashingService;
...
import com.cambiazo.user.infrastructure.persistence.jpa.repositories.RoleRepository;
...
//    private final IProductRepository productRepository;
    ...
    @Override
    public Optional<User> validateCredentials(SignInCommand command) {
